import { getDatabase, hashPassword, generateSalt } from "../src/server/db";
...
async function main() {
  ...
  // 1. Workspace
  console.log("[Seed] Seeding primary tenant workspace...");
  await db.execute(
  ...
  console.log("[Seed] Seeding users with 600,000-iteration PBKDF2 hashes...");
  ...
  // 3. Projects
  console.log("[Seed] Seeding normalized enterprise projects...");
  const projects = [
  ...
  // 4. Milestones
  console.log("[Seed] Seeding project milestones...");
  const milestones = [
  ...
  // 5. Tasks
  console.log("[Seed] Seeding project tasks...");
  const tasks = [
  ...
  // 6. Employees
  console.log("[Seed] Seeding HRM employees...");
  const employees = [
  ...
  // 7. Assets
  console.log("[Seed] Seeding company assets...");
  const assets = [
  ...
  // 8. RBAC Matrix
  console.log("[Seed] Seeding role-based access control capabilities...");
