      ...
      const response = await fetch("/api/ai/ask", {
        ...
        body: JSON.stringify({
          ...
          context: {
            ...
            deals: deals.map((d) => ({ name: d.name, amount: d.amount, stage: d.stage, probability: d.probability })),
            projects: projects.map((p) => ({ name: p.name, status: p.status, health: p.health, budget: p.budget })),
          },
        }),
      });
